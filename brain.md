...
| **Postmortem Store** | `AWS::S3::Bucket` (`loopguard-postmortems-...`) | `template.yaml` | S3 bucket storing auto-generated Markdown SRE postmortems with 7-day lifecycle expiration. |
